...
advent1_2 = sum $ map ((read :: (String -> Int)) . twoDigitNumber . filter isNumber . replaceDigitStrings) $ splitOn "\n" input

-- Code

twoDigitNumber l = [head l, last l]

replaceDigitStrings l = replaceDigitStrings' "" l
replaceDigitStrings' l [] = reverse l
replaceDigitStrings' l ('o':'n':'e':xs)         = replaceDigitStrings' ('1':l) ('n':'e':xs)
replaceDigitStrings' l ('t':'w':'o':xs)         = replaceDigitStrings' ('2':l) ('w':'o':xs)
replaceDigitStrings' l ('t':'h':'r':'e':'e':xs) = replaceDigitStrings' ('3':l) ('h':'r':'e':'e':xs)
replaceDigitStrings' l ('f':'o':'u':'r':xs)     = replaceDigitStrings' ('4':l) ('o':'u':'r':xs)
replaceDigitStrings' l ('f':'i':'v':'e':xs)     = replaceDigitStrings' ('5':l) ('i':'v':'e':xs)
replaceDigitStrings' l ('s':'i':'x':xs)         = replaceDigitStrings' ('6':l) ('i':'x':xs)
replaceDigitStrings' l ('s':'e':'v':'e':'n':xs) = replaceDigitStrings' ('7':l) ('e':'v':'e':'n':xs)
replaceDigitStrings' l ('e':'i':'g':'h':'t':xs) = replaceDigitStrings' ('8':l) ('i':'g':'h':'t':xs)
replaceDigitStrings' l ('n':'i':'n':'e':xs)     = replaceDigitStrings' ('9':l) ('i':'n':'e':xs)
replaceDigitStrings' l (x:xs)                   = replaceDigitStrings' (x:l) xs


-- Input

example_input = [here|1abc2
pqr3stu8vwx
a1b2c3d4e5f
treb7uchet|]

example_input2 = [here|two1nine
eightwothree
abcone2threexyz
xtwone3four
4nineeightseven2
